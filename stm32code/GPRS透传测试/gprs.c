...
//		printf("AT+QILPORT=\042UDP\042,\04212345\042\r\n");//设置本地端口
//		Delayms(300);
...
//		
		...
		//printf("AT+QIOPEN=\042TCP\042,\04247.92.30.216\042,\04212307\042\r\n");//这里是需要登陆的IP号码，输入公网的IP以及端口号就可以了。
		//printf("AT+QIOPEN=\042UDP\042,\042121.40.103.153\042,\0428998\042\r\n");
		printf("AT+QIOPEN=\042UDP\042,\042106.15.178.106\042,\0428998\042\r\n");
		//printf("AT+QIOPEN=\042UDP\042,\04247.92.30.216\042,\0428998\042\r\n");
		Delayms(100);
...
{			
		...
		clear_buffer();
		//printf("AT+QIOPEN=\042TCP\042,\042172.26.5.87\042,\04212307\042\r\n");//这里是需要登陆的IP号码，输入公网的IP以及端口号就可以了。
